...
function App(){
  ...
  const AUTH_URL = "https://account.spotify.com/authorize?client_id=311906a38acc48219efd2b84c14178c0&response_type=code&redirect_uri=http://localhost:3000&scope=streaming%20user-read-email%20user-read-private%20user-read-playback-state%20user-modify-playback-state%20user-read-currently-playing  "
  ...
  return (
    ...
    <div className='app'>
      <div className='search'>
        ...
        <h2>
        <a href={AUTH_URL}style={{color:'whitesmoke'}}>Login to Spotify</a>
        </h2>
    ...
    <div className='container'>
      <div className='top'>
        ...
        <div className='description'>
          {data.weather?<p style={{fontSize:"4em"}}>{data.weather[0].description}</p>:null}
        </div>
        {data.name !== undefined &&
